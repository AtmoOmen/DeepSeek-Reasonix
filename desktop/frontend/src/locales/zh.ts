...
export const zh: Record<DictKey, string> = {
  ...
  "caps.trustedReadOnlyTools": "可信只读",
  "caps.trustReportedReadOnly": "信任只读（{count}）",
  "caps.trustReportedReadOnlyTitle": "信任当前列表中此 MCP 服务器自报为只读的全部工具",
  "caps.reportedReadOnly": "自报只读",
  "caps.reportedReadOnlyTitle": "此 MCP 服务器声明了 readOnlyHint；Reasonix 仍要求显式信任后才允许 planner / research 使用",
  "caps.untrustReadOnly": "取消信任",
  "caps.untrustReadOnlyTitle": "从 planner / research 的可信只读清单中移除此 MCP 工具",
  "caps.trustReadOnlyTitle": "将此 MCP 工具标记为 planner / research 可用的可信只读工具",
  "caps.trustedReadOnlyTitle": "已作为 planner / research 可用的可信只读工具",
  ...
  "memory.systemPromptTitle": "系统提示词",
  "memory.systemPromptHint": "直接编辑 Agent 的系统提示词。修改后立即生效，会参与每一次对话。",
  "memory.systemPromptScope": "系统级",
