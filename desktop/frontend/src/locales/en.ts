...
export const en = {
  ...
  "caps.trustReadOnly": "Trust",
  "caps.trustedReadOnly": "Trusted",
  "caps.trustedReadOnlyTools": "Trusted read-only",
  "caps.trustReportedReadOnly": "Trust read-only ({count})",
  "caps.trustReportedReadOnlyTitle": "Trust every currently listed tool this MCP server reports as read-only",
  "caps.reportedReadOnly": "reported read-only",
  "caps.reportedReadOnlyTitle": "This MCP server reports readOnlyHint; Reasonix still requires explicit trust for planner and research",
  "caps.untrustReadOnly": "Untrust",
  "caps.untrustReadOnlyTitle": "Remove this MCP tool from the planner and research trusted read-only list",
  "caps.trustReadOnlyTitle": "Mark this MCP tool as trusted read-only for planner and research",
  "caps.trustedReadOnlyTitle": "Trusted as read-only for planner and research",
  ...
  "memory.systemPromptTitle": "System prompt",
  "memory.systemPromptHint": "Edit the agent's system prompt directly. Changes take effect immediately and participate in every conversation.",
  "memory.systemPromptScope": "System",
